...
- sections: 4 to 6 of them. Each has:
    ...
    steps: Use these wherever the section genuinely describes something done in order -- what to do before a lesson, how to run a maneuver, how to come back from a gap. Most articles about training have at least one such section, and a procedure written as a paragraph beginning "First," is harder to follow than the same thing numbered. Only when order matters, and only with 2 or more steps. A numbered list of unordered points is a paragraph wearing a costume. Most sections have none. Each step is one short imperative sentence.

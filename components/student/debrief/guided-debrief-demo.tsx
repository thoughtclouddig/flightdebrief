...
/**
 * The guided debrief -- the complete fixture-backed 9-stage demo flow, shared
 * between app/prototype/vector/debrief/new/page.tsx and
 * app/v2/debrief/new/page.tsx. Not the real production debrief lifecycle
...
export function GuidedDebriefDemo({
  ...
  return (
    <Screen>
      ...
      {stage === "review" ? <Review resultHref={resultHref} /> : null}
    </Screen>
  );
}
...
function Review({ resultHref }: { resultHref: string }) {
  return (
    <>
      <Panel>
      ...
      <div className="flex flex-col gap-2.5">
        <PrimaryButton href={resultHref}>Looks right</PrimaryButton>
        <SecondaryButton href={resultHref}>Edit something</SecondaryButton>
      </div>
    </>
  );
}

  ...
  return (
    <section id="flight-recording" className="bg-white px-6 py-20 sm:py-24">
      ...
      <Reveal>
        ...
        <p className="mt-5 text-balance text-lg leading-relaxed text-[#68717D]">
        ...
        <p className="mt-6 border-t border-black/[0.08] pt-5 text-balance text-sm leading-relaxed text-[#8c97a2]">

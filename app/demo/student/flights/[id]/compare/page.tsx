...
/** Public Student demo's Compare Attempts -- the same CompareAttemptsScreen component and telemetry math app/v2/flights/[id]/compare/page.tsx renders, hrefs built from /demo/student instead of /v2. */
export default async function DemoStudentComparePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <CompareAttemptsScreen
      ...
      replayHrefA={HREFS.flightReplay(id, Math.round(a.startT))}
      replayHrefB={HREFS.flightReplay(id, Math.round(b.startT))}

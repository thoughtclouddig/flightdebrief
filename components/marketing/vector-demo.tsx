  ...
  return (
    <div className="overflow-hidden rounded-[28px] bg-[#142033] p-7 shadow-[0_30px_60px_-30px_rgba(16,23,39,0.45)] sm:p-9">
      ...
      <div className="mt-8 min-h-[430px]" aria-live="polite">
        {phase === "prompts" ? (
          <>
            <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#9da7b8]">Ask about your own training</p>
              ...
              {ANSWERS.map((a, i) => (
                <li key={a.prompt}>
                  <button
                    ...
                    onClick={() => pick(i)}
                    className={cn(
                      "w-full cursor-pointer rounded-2xl border px-4 py-3.5 text-left text-base leading-snug text-white transition-colors duration-200",
                      i === index && !tookOver

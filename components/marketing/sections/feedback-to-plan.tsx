  ...
  return (
    <div className="relative flex gap-5 pl-1">
      ...
      <div className={last ? "pb-1" : "pb-10"}>
        <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#8c97a2]">{eyebrow}</p>
        ...
        <Reveal delay={150} className="mx-auto mt-16 max-w-2xl">
          ...
          <div className="rounded-[40px] bg-gradient-to-b from-[#e4e5e8] to-[#d3d5d9] p-3 shadow-[0_1px_2px_rgba(16,23,39,0.04),0_24px_60px_-20px_rgba(16,23,39,0.16)] ring-1 ring-black/[0.08] sm:p-4">
            ...
            <div className="rounded-[26px] bg-white p-8 ring-1 ring-black/[0.05] sm:p-10">
              <p className="mb-6 text-xs font-bold uppercase tracking-[0.14em] text-brand">
                Today&rsquo;s Flight &middot; Steep Turns
              </p>

              <ThreadBlock icon={Target} eyebrow="Area to improve">
                <p className="font-display text-lg font-bold text-[#101727]">Altitude control</p>
                <p className="mt-1 text-sm text-[#68717D]">Altitude increased 180 ft during the second half of the turn.</p>
              </ThreadBlock>
              ...
              <ThreadBlock icon={ShieldCheck} eyebrow="ACS connection">
                <p className="text-xs font-bold uppercase tracking-wide text-[#8c97a2]">FAA Airman Certification Standards</p>
                <p className="font-display mt-1 text-base font-bold text-[#101727]">Steep Turns &middot; PA.V.A.S3</p>
                <p className="mt-0.5 text-sm text-[#68717D]">Maintain altitude &plusmn;100 feet</p>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {NEXT_FLIGHT_STATS.map((stat) => (
                    <div key={stat.label}>
                      ...
                      <p className="font-display mt-0.5 text-sm font-bold text-[#101727]">{stat.value}</p>
                    </div>
                  ))}
                </div>
              </ThreadBlock>

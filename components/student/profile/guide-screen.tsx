...
/**
 * The guide -- shared between app/prototype/vector/profile/guide/page.tsx
 * and app/v2/profile/guide/page.tsx.
 *
...
export function GuideScreen({ backHref, acsArea }: { backHref: string; acsArea: string }) {
  return (
    <Screen>
      ...
      <Section title={<>What Vector is</>} flush>
        <Card className="flex flex-col gap-3">
          ...
          <p className="text-[15px] leading-relaxed text-foreground-soft">
            ...
            already knowing your debriefs, what your instructor flagged, what keeps recurring, and what you&rsquo;re
            working on next.
          </p>
          <p className="text-[15px] leading-relaxed text-foreground-soft">
      ...
      <Section title={<>What the scores mean</>} flush>
        <Card className="flex flex-col gap-6">
          ...
          <AcsBadge area={acsArea} code="PA.IV.B" />
          <p className="text-[15px] leading-relaxed text-foreground-soft">

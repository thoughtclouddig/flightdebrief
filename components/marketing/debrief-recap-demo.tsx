  ...
  return (
    <Reveal className="mt-20">
      <div className="mx-auto max-w-4xl rounded-3xl border border-slate-200 bg-white px-6 py-12 text-center shadow-sm sm:px-16 sm:py-16">
        ...
        <div className="mx-auto mt-10 max-w-2xl rounded-2xl border border-slate-200 bg-[#f4f5f6] p-6 text-left sm:p-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-display text-base font-bold text-[#101727]">Mia&rsquo;s Debrief Recap</p>
          ...
          <div className="mt-6 flex items-center gap-4">
            <button
              ...
              className="flex size-12 shrink-0 items-center justify-center rounded-full bg-brand text-white transition-[transform,box-shadow] duration-150 ease-out hover:-translate-y-0.5 hover:shadow-lg hover:shadow-brand/25 active:translate-y-0"
            >
            ...
            <span className="shrink-0 text-xs font-medium tabular-nums text-[#68717D]">
              {formatTime(currentTime)} / {formatTime(duration)}
            </span>
          </div>

          <p className="mt-4 text-xs font-medium uppercase tracking-wide text-[#68717D]/70">AfterFlight Digital Debriefer</p>
        </div>

    ...
    <section className="bg-white px-6 pb-20 pt-32 sm:pb-28 sm:pt-36">
      <div className="mx-auto max-w-3xl">
        <Reveal>
          ...
          <p className="mt-3 text-pretty text-lg leading-relaxed text-[#414B57]">
        ...
        <Reveal delay={100} className="mt-10 flex flex-col gap-5">
          {reports.length === 0 ? (
            <p className="text-pretty leading-relaxed text-[#414B57]">
            ...
            reports.map((report) => (
              ...
              >
                ...
                <div>
                  ...
                  {report.summary ? <p className="mt-1.5 text-pretty text-[#414B57]">{report.summary}</p> : null}
                </div>
              </Link>
            ))
          )}

    ...
    <>
        ...
        <div className="mx-auto max-w-[1320px]">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <Reveal>
              ...
              <p className="mt-6 max-w-md text-pretty text-lg leading-relaxed text-[#414B57] tracking-[0.01em]">
      ...
      <section className="bg-[#f4f5f6] px-6 py-20 sm:py-28">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-8 text-pretty text-lg text-[#414B57] tracking-[0.01em]">
        ...
        <div className="mx-auto max-w-[1320px]">
          ...
          <div className="mt-14 grid grid-cols-1 gap-8 lg:grid-cols-2">
            <Reveal className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-8">
              ...
              <p className="text-pretty text-[#4E5A67] tracking-[0.01em]">
      ...
      <section className="bg-[#f4f5f6] px-6 py-20 sm:py-28">
        <div className="mx-auto max-w-[1320px]">
          <Reveal className="mx-auto max-w-2xl rounded-2xl border border-slate-200 bg-white p-8 text-center">
            ...
            <p className="mt-3 text-pretty text-[#414B57] tracking-[0.01em]">
        ...
        <div className="mx-auto max-w-[1320px]">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <Reveal>
              ...
              <p className="mt-4 text-pretty text-base text-[#414B57] tracking-[0.01em]">
          ...
          <div className="mx-auto mt-14 grid max-w-4xl grid-cols-1 gap-8 sm:grid-cols-3">
            {WORKFLOW.map((item, i) => (
              <Reveal key={item.step} delay={i * 100} className="flex flex-col items-start gap-3">
                ...
                <p className="text-pretty text-base text-[#414B57] tracking-[0.01em]">{item.copy}</p>
              </Reveal>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white px-6 py-20 sm:py-28">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-pretty text-lg text-[#414B57] tracking-[0.01em]">
      ...
      <section className="bg-[#f4f5f6] px-6 py-14">
        <div className="mx-auto max-w-[1320px]">
          <Reveal className="text-center">
            <p className="text-[#414B57] tracking-[0.01em]">

...
export function LiveDemoBanner({ expiresAt }: { expiresAt: string }) {
  const timeLeft = formatTimeLeft(expiresAt);

  return (
    <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 bg-brand px-4 py-2 text-center text-sm font-medium text-white">
